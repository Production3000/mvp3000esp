...
MicroPlot3000 = new function() {
    ...
    $.plotData = function() {
        ...
        $.domElement.querySelector('.xaxis div').textContent = `starting ${dtStart.getFullYear()}-${(dtStart.getUTCMonth() + 1).toString().padStart(2, '0')}-${dtStart.getUTCDate().toString().padStart(2, '0')} ${dtStart.getUTCHours().toString().padStart(2, '0')}:${dtStart.getUTCMinutes().toString().padStart(2, '0')}:${dtStart.getUTCSeconds().toString().padStart(2, '0')} with units ${unitString}`;
